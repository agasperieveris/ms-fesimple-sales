...
public class SalesManagmentServiceTest {
        ...
        static void setup() {
                ...
                salesRequest = PostSalesRequest.builder().sale(sale).headersMap(headersMap).build();

                businessParametersReasonCode = BusinessParametersReasonCode.builder()
                                .data(Arrays.asList(
                                                BusinessParameterReasonCodeData.builder()
                                                                .ext(Arrays.asList(ReasonCodeExt.builder().casi(false)
                                                                                .caeq(false).capl(false).build()))
                                                                .build()))
                                .build();
        }
        ...
        void postSalesTest() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException {
                ...
                PostSalesRequest salesRequest = PostSalesRequest.builder().sale(sale).headersMap(headersMap).build();

                BusinessParameterExt ext1 = BusinessParameterExt.builder().codComercialOperationType("CAEQ")
                                .codActionType("CW").codCharacteristicId("9941")
                                .codCharacteristicCode("AcquisitionType").codCharacteristicValue("private").build();
                List<BusinessParameterExt> extList = new ArrayList<>();
                extList.add(ext1);
                BusinessParameterData businessParameterData1 = BusinessParameterData.builder().ext(extList).build();
                BusinessParameterDataSeq businessParameterData2 = BusinessParameterDataSeq.builder().active(false)
                                .build();
                ...
                GetSalesCharacteristicsResponse businessParametersResponse = GetSalesCharacteristicsResponse.builder()
                                .data(dataList).build();
                BusinessParametersResponse expectBusinessParametersResponse = BusinessParametersResponse.builder()
                                .data(dataList2).build();

                BusinessParametersFinanciamientoFijaResponse bpFijaResponse = BusinessParametersFinanciamientoFijaResponse
                                .builder()
                                .data(Arrays.asList(BusinessParameterFinanciamientoFijaData.builder().ext(Arrays.asList(
                                                BusinessParameterFinanciamientoFijaExt.builder().id(1).nomProductType(
                                                                "Landline").nomParameter("financialEntity")
                                                                .desParameterTitle("Código de financiamiento fija")
                                                                .codParameterValue("FVFIR00006").build(),
                                                BusinessParameterFinanciamientoFijaExt.builder().id(2)
                                                                .nomProductType("Landline")
                                                                .nomParameter("chargeCodeInstallation")
                                                                .desParameterTitle(
                                                                                "Código de financiamiento asociado a la instalación")
                                                                .codParameterValue("FRVTSE_001").build(),
                                                BusinessParameterFinanciamientoFijaExt.builder().id(3)
                                                                .nomProductType("Landline")
                                                                .nomParameter("chargeCodeDevicePremium")
                                                                .desParameterTitle(
                                                                                "Código de financiamiento asociado a Upgrade a Modem Premium")
                                                                .codParameterValue("FRIOEQ_002").build(),
                                                BusinessParameterFinanciamientoFijaExt.builder().id(4)
                                                                .nomProductType("Landline")
                                                                .nomParameter("chargeCodeUltraWifi")
                                                                .desParameterTitle(
                                                                                "Código de financiamiento asociado a Ultra Wifi")
                                                                .codParameterValue("FRIOEQ_007").build()))
                                                .build()))
                                .build();
                ...
                Method methodMainFuntion = SalesManagmentServiceImpl.class.getDeclaredMethod("mainFunction", Sale.class,
                                PostSalesRequest.class, Boolean[].class, Boolean[].class, Boolean[].class,
                ...
                methodMainFuntion.invoke(salesManagmentServiceImpl, sale, salesRequest, flagTrue, flag, flag, flag,
                                flag, false, sapidSimcard);

                salesRequest.getSale().getAdditionalData().stream()
                                .filter(item -> item.getKey().equalsIgnoreCase("ufxauthorization")).findFirst()
                ...
                salesRequest.getSale().getCommercialOperation().get(0).getDeviceOffering().get(0).getStock()
                ...
                method.invoke(salesManagmentServiceImpl, bpFinanciamientoFijaResponseList, salesRequest.getSale(),
                                salesRequest, false, "string");
                ...
                Method method2 = SalesManagmentServiceImpl.class.getDeclaredMethod("validationsAndBuildings",
                                ...
                                BusinessParametersResponseObjectExt.class, BusinessParametersReasonCode.class,
                                Sale.class, PostSalesRequest.class, String[].class, String.class, Boolean[].class,
                                Boolean[].class, Boolean[].class, Boolean[].class, Boolean[].class, String.class,
                                String.class, String.class, Boolean.class, String.class);
                method2.setAccessible(true);

                BusinessParametersResponse getRiskDomain = MapperUtils.mapper(BusinessParametersResponse.class,
                                "{\"metadata\":{\"info\":\"Dominios de Riesgos SPAN\",\"type\":\"KeyValueActive\",\"label\":{\"key\":\"id\",\"value\":\"nombreDominio\",\"active\":\"estado\",\"ext\":\"-\"}},\"data\":[{\"key\":\"430\",\"value\":\"plusmail.cf\",\"active\":false,\"ext\":\"-\"}]}");
                BusinessParametersResponse getRiskDomainTrue = MapperUtils.mapper(BusinessParametersResponse.class,
                                "{\"metadata\":{\"info\":\"Dominios de Riesgos SPAN\",\"type\":\"KeyValueActive\",\"label\":{\"key\":\"id\",\"value\":\"nombreDominio\",\"active\":\"estado\",\"ext\":\"-\"}},\"data\":[{\"key\":\"430\",\"value\":\"plusmail.cf\",\"active\":true,\"ext\":\"-\"}]}");
                BusinessParametersResponseObjectExt getBonificacionSim = MapperUtils.mapper(
                                BusinessParametersResponseObjectExt.class,
                                "{\"metadata\":{\"info\":\"Códigos de bonificación\",\"type\":\"KeyValueActiveExt\",\"label\":{\"key\":\"channel\",\"value\":\"productSpecPricingID\",\"active\":\"active\",\"ext\":\"parentProductCatalogID\"}},\"data\":[{\"key\":\"CC\",\"value\":\"34572615\",\"active\":true,\"ext\":\"7431\"}]}");
                BusinessParametersResponseObjectExt getParametersSimCard = MapperUtils.mapper(
                                BusinessParametersResponseObjectExt.class,
                                "{\"metadata\":{\"info\":\"Parámetros del simcard para sales\",\"type\":\"KeyValueActiveExt\",\"label\":{\"key\":\"codParam\",\"value\":\"desParam\",\"active\":\"active\",\"ext\":\"-\"}},\"data\":[{\"key\":\"sku\",\"value\":\"SKU0001\",\"active\":true,\"ext\":\" \"},{\"key\":\"sapid\",\"value\":\"TSPE4128234R510201\",\"active\":true,\"ext\":\"-\"}]}");
                ...
                String productOfferingIdRequest = salesRequest.getSale().getCommercialOperation().get(0)
                                .getProductOfferings().get(0).getId();
                method2.invoke(salesManagmentServiceImpl, getRiskDomainTrue,
                                Arrays.asList(BusinessParameterExt.builder().build()), getBonificacionSim,
                                getParametersSimCard, businessParametersReasonCode, salesRequest.getSale(),
                                salesRequest, sapidSimcard, commercialOperationReason, flag, flag, flag, flag, flag,
                                channelIdRequest, customerIdRequest, productOfferingIdRequest, false, null);
        ...
        void retryRequest_Test() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
                ...
                Mockito.when(stockWebClient.reserveStock(any(), any(), any()))
                                .thenReturn(Mono.just(reserveStockResponse));

                PostSalesRequest salesRequest = PostSalesRequest.builder().sale(sale).headersMap(headersMap).build();

                Method method = SalesManagmentServiceImpl.class.getDeclaredMethod("retryRequest",
                                PostSalesRequest.class, Sale.class, Boolean.class, Boolean.class, Boolean.class,
        ...
        @Test
        void assignBillingOffers_Test()
                        throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
                Method method = SalesManagmentServiceImpl.class.getDeclaredMethod("assignBillingOffers", List.class,
        ...
        @Test
        void postSales_MigracionFija_Test()
        ...
        void postSalesIdNotFoundErrorTest() {
                ...
                PostSalesRequest salesRequest = PostSalesRequest.builder().sale(saleTest).headersMap(headersMap)
                                .build();
        ...
        void postSalesRetailMovilImeiNotFoundErrorTest() {
                ...
                saleTest.setAdditionalData(
                                Arrays.asList(KeyValueType.builder().key("flowSale").value("Retail").build()));
        ...
        void postSalesRetailsSimIccidNotFoundErrorTest() {
                ...
                saleTest.getAdditionalData().stream().filter(item -> item.getKey().equalsIgnoreCase("flowSale"))
                                .findFirst().ifPresent(item -> item.setValue("Retail"));
        ...
        void additionalDataAssigments_Lima_Test() {
                ...
                CommercialOperationType commercialOperationType = CommercialOperationType.builder()
                                .workOrDeliveryType(WorkOrDeliveryType.builder().place(placeList).build()).build();
                ...
                salesManagmentServiceImpl.additionalDataAssigments(null,
                                Sale.builder().channel(ChannelRef.builder().storeId("string").build())
        ...
        void caplCommercialOperationTest() {
                ...
                CreateProductOrderGeneralRequest result = salesManagmentServiceImpl.caplCommercialOperation(sale,
                                mainCaplRequestProductOrder, "CC", "CS465", "OF824", "A83HD345DS", getBonificacionSim,
                                false);
        ...
        void caeqCommercialOperationTest() {
                ...
                CreateProductOrderGeneralRequest result = salesManagmentServiceImpl.caeqCommercialOperation(sale,
                                mainCaeqRequestProductOrder, false, "CEC", "CS920", "OF201", "JSG423DE6H", "string",
                                businessParametersReasonCode, getBonificacionSim, false);

                /*
                 * CreateProductOrderGeneralRequest mainCaeqRequestProductOrderCaeqCasi = new
                 * CreateProductOrderGeneralRequest();
                 * salesManagmentServiceImpl.caeqCommercialOperation(saleCaeqCaplCasi,
                 * mainCaeqRequestProductOrderCaeqCasi, true,
                 * saleCaeqCaplCasi.getChannel().getId(), "CS920", "OF201", "JSG423DE6H",
                 * "string");
                 */
        }
        ...
        void caeqCaplCommercialOperationTest() {
                ...
                CreateProductOrderGeneralRequest result = salesManagmentServiceImpl.caeqCaplCommercialOperation(sale,
                                mainCaeqCaplRequestProductOrder, false, "CC", "CS158", "OF486", "K3BD9EN349", "string",
                                businessParametersReasonCode, getBonificacionSim, false);
        }
        ...
        void getChangedContainedCaeqListTest() {
                ...
                sale.getCommercialOperation().get(0).setDeviceOffering(Collections
                                .singletonList(sale.getCommercialOperation().get(0).getDeviceOffering().get(0)));
                salesManagmentServiceImpl.changedContainedCaeqList(sale, "temp1", "string", false);
        }

        @Test
        void setChangedContainedProductProductId_Test()
                        throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
                ...
                method.setAccessible(true);
                method.invoke(salesManagmentServiceImpl, ChangedContainedProduct.builder().build(),
                                Arrays.asList(RelatedProductType.builder().product(ProductRefInfoType.builder()
                                                .description("SimDevice").name("Device").id("string")
                                                .productRelationship(Collections
                                                                .singletonList(ProductProductRelationShip.builder()
                                                                                .product(ProductRelationShipProduct
                                                                                                .builder()
                                                                                                .description("Device")
                                                                                                .id("8091734238")
                                                                                                .build())
        ...
        void buildReserveStockRequestTest()
                ...
                Method method = SalesManagmentServiceImpl.class.getDeclaredMethod("buildReserveStockRequest",
                                ReserveStockRequest.class, Sale.class, CreateProductOrderResponseType.class,
                                String.class);
                ...
                CreateProductOrderResponseType createProductOrderResponse = CreateProductOrderResponseType.builder()
                                .productOrderReferenceNumber("761787835447").productOrderId("930686A")
                                .newProductsInNewOfferings(
                                                Arrays.asList(NewProductInNewOfferingInstanceConfigurationType.builder()
                                                                .productOrderItemReferenceNumber("123456789A").build()))
                                .build();
        ...
        void postSalesEventFlowTest() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
                ...
                Sale sale = CommonsMocks.createSaleMock();
                PostSalesRequest postSalesRequest = PostSalesRequest.builder().sale(sale).headersMap(headersMap)
                                .build();
        ...
        @Test
        void postSalesEventFlow_when_AdditionalDataIsNull_Test()
                        throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
                Method method = SalesManagmentServiceImpl.class.getDeclaredMethod("postSalesEventFlow",
                                PostSalesRequest.class);
                ...
                Sale sale = new Sale();
                sale.setCommercialOperation(
                                Collections.singletonList(CommercialOperationType.builder().reason("CAPL").build()));
        ...
        @Test
        void callToReserveStockAndCreateQuotationTest()
                        throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
                Method method = SalesManagmentServiceImpl.class.getDeclaredMethod(
                                "callToReserveStockAndCreateQuotation", PostSalesRequest.class, Sale.class,
        ...
        @Test
        void callToCreateQuotation_when_FlgFinanciamientoIsTrue_Test()
                        throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
                ...
                Mockito.when(quotationWebClient.createQuotation(any(), any()))
                                .thenReturn(Mono.just(createQuotationResponse));

                method.invoke(salesManagmentServiceImpl, postSalesRequest, sale, false, true);
        }

        @Test
        void callToCreateQuotation_when_FlgFinanciamientoIsFalse_Test()
                        throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
                Method method = SalesManagmentServiceImpl.class.getDeclaredMethod("callToCreateQuotation",
                                PostSalesRequest.class, Sale.class, Boolean.class, Boolean.class);
        ...
        @Test
        void commercialOperationInputValidations_Test()
                        throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
                Method method = SalesManagmentServiceImpl.class.getDeclaredMethod("commercialOperationInputValidations",
                                Sale.class);
                method.setAccessible(true);
                method.invoke(salesManagmentServiceImpl,
                                Sale.builder().commercialOperation(Collections
                                                .singletonList(CommercialOperationType.builder().productOfferings(null)
                                                                .deviceOffering(null).additionalData(null).build()))
                                                .build());
        }
        ...
        void wirelineMigrations_Test() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
                ...
                Method method = SalesManagmentServiceImpl.class.getDeclaredMethod("wirelineMigrations", List.class,
                                PostSalesRequest.class, String.class, Boolean.class, String.class);
                method.setAccessible(true);

                method.invoke(salesManagmentServiceImpl,
                                bpFinanciamientoFijaResponseList.get(0).getData().get(0).getExt(), salesRequest, "CH",
                                false, null);

                /*
                 * Method methodFillProductOfferingProductSpecId =
                 * SalesManagmentServiceImpl.class.getDeclaredMethod(
                 * "fillProductOfferingProductSpecId", List.class, List.class);
                 ...
                 * Arrays.asList(MigrationComponent.builder() .componentName("landline")
                 * .build()), sale.getCommercialOperation().get(0).getProductOfferings().get(0).
        ...
        void buildGenesisError_Test() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
                Method method = SalesManagmentServiceImpl.class.getDeclaredMethod("buildGenesisError", String.class,
                                String.class);
                method.setAccessible(true);
        ...
        void addOrderIntoSale_Test() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
                ...
                Method method = SalesManagmentServiceImpl.class.getDeclaredMethod("addOrderIntoSale",
                                PostSalesRequest.class, Sale.class, CreateQuotationRequest.class,
                                ProductorderResponse.class);
                method.setAccessible(true);

                method.invoke(salesManagmentServiceImpl, salesRequest, sale, new CreateQuotationRequest(),
                                ProductorderResponse.builder().createProductOrderResponse(CreateProductOrderResponseType
                                                .builder().productOrderId("string").build()).build());
                ...
                method.invoke(salesManagmentServiceImpl, salesRequest, sale, new CreateQuotationRequest(),
                                ProductorderResponse.builder().createProductOrderResponse(CreateProductOrderResponseType
                                                .builder().productOrderId("string").build()).build());
                method.invoke(salesManagmentServiceImpl, salesRequest, sale, new CreateQuotationRequest(),
                                ProductorderResponse.builder().createProductOrderResponse(
                                                CreateProductOrderResponseType.builder().productOrderId("").build())
                                                .build());
        }

        @Test
        void deviceOfferingIsNullOrEmpty_Test()
                        throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
                Method method = SalesManagmentServiceImpl.class.getDeclaredMethod("deviceOfferingIsNullOrEmpty",
                                Sale.class);
                method.setAccessible(true);
        ...
        @Test
        void changedContainedCaeqList_Test()
                        throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
                Method method = SalesManagmentServiceImpl.class.getDeclaredMethod("changedContainedCaeqList",
                                Sale.class, String.class, String.class, Boolean.class);
                method.setAccessible(true);
                method.invoke(salesManagmentServiceImpl, saleCaeqCaplCasi, "string", "string", true);
        }

        @Test
        void getCipCode_flgFinanciamiento_Test()
                        throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        @Test
        void getCipCode_paymentType_Test() throws GenesisException, NoSuchMethodException, InvocationTargetException,
                ...
                ;
                method.invoke(salesManagmentServiceImpl,
                                PaymentType.builder().additionalData(Collections.singletonList(KeyValueType.builder()
                                                .key("paymentMediumLabel").value("Pago Efectivo").build()))
                                                .cid("string").build(),
                                true, true);
        }
}