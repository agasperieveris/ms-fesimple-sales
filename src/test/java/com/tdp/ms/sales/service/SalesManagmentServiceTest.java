...
public class SalesManagmentServiceTest {
    ...
    void caeqCaplCommercialOperationTest() {
        ...
        /*CreateProductOrderGeneralRequest mainCaeqRequestProductOrderCaeqCaplCasi = new CreateProductOrderGeneralRequest();
        salesManagmentServiceImpl.caeqCaplCommercialOperation(saleCaeqCaplCasi, mainCaeqRequestProductOrderCaeqCaplCasi,
                true, saleCaeqCaplCasi.getChannel().getId(), "CS920", "OF201", "JSG423DE6H", "string");*/
    }
