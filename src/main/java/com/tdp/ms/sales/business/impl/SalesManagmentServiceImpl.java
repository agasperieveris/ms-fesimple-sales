...
public class SalesManagmentServiceImpl implements SalesManagmentService {
        ...
        private void postSalesEventFlow(PostSalesRequest request) {
                ...
                webClientReceptor.register(
                                ReceptorRequest.builder().businessId(request.getSale().getSalesId())
                                                .typeEventFlow(FLOW_SALE_POST).message(request.getSale()).build(),
        ...
        private void buildOrderAttributesListAltaFija(List<FlexAttrType> altaFijaOrderAttributesList, Sale saleRequest,
                        CreateQuotationRequest createQuotationFijaRequest, Boolean flgFinanciamiento) {
                ...
                FlexAttrType externalFinancialAttr = FlexAttrType.builder().attrName(Constants.IS_EXTERNAL_FINANCING)
                                .flexAttrValue(externalFinancialAttrValue).build();

                FlexAttrValueType upFrontIndAttrValue = FlexAttrValueType
                                .builder().stringValue(saleRequest.getCommercialOperation().get(0).getProductOfferings()
                ...
                if (saleRequest.getCommercialOperation() != null
                        ...
                        FlexAttrValueType downPaymentAttrValue = FlexAttrValueType.builder()
                                        .stringValue(createQuotationFijaRequest.getBody().getDownPayment().getAmount())
                                        .valueType("TC").build();
                        FlexAttrType downPaymentAttr = FlexAttrType.builder().attrName("DELIVERY_METHOD")
                                        .flexAttrValue(downPaymentAttrValue).build();
                        altaFijaOrderAttributesList.add(downPaymentAttr);
                }
        }
                                ...
                                .forEach(availabilityOffer -> {
                                        ...
                                        if (serviceAbilityType.equalsIgnoreCase("VOICE")) {
                                                ...
                                                CharacteristicOfferType describeByLandline1 = CharacteristicOfferType
                                                                ...
                                                                .characteristicValue(availabilityOffer.getServices()
                                                                                .get(0).getAllocationId())
                                                                .build();
                                                ...
                                                ProductLineType productOfferLandline1 = ProductLineType.builder()
                                                                .type(serviceAbilityType).description("Servicio de Voz")
                                                ...
                                                ServiceabilityOfferType serviceabilityOfferLandline = ServiceabilityOfferType
                                                                .builder()
                                                                .idOfferPriority(availabilityOffer.getPriority()
                                                                                .toString())
        ...
        private List<NewProductAltaFija> buildNewProductsAltaFijaList(Sale saleRequest,
                ...
                saleRequest.getCommercialOperation().get(0).getProductOfferings().get(0).getProductSpecification()
                                .stream().forEach(productSpecification -> {
                                        ...
                                        if (productType.equalsIgnoreCase(Constants.PRODUCT_TYPE_LANDLINE)) {
                                                ...
                                                NewProductAltaFija newProductAltaFijaLandline = NewProductAltaFija
                                                                ...
                                                                .productCatalogId(productSpecification
                                                                                .getRefinedProduct()
                                                                                .getProductCharacteristics().get(0)
                                                                                .getId())
                                                                .temporaryId("temp").baId(baId).accountId(accountId)
                                                ...
                                                if (!newAssignedBillingOffersLandlineList.isEmpty()) {
                                                        ...
                                                        ProductChangeAltaFija productChangesLandline = ProductChangeAltaFija
                                                                        ...
                                                                        .build();
                                                        newProductAltaFijaLandline
                                                                        .setProductChanges(productChangesLandline);
                                                }
                                                ...
                                                ChangedCharacteristic changedCharacteristicBroadband1 = ChangedCharacteristic
                                                                ...
                                                                .characteristicValue(saleRequest
                                                ...
                                                NewProductAltaFija newProductAltaFijaBroadband = NewProductAltaFija
                                                                ...
                                                                .temporaryId("temp").baId(baId).accountId(accountId)
                                                                .invoiceCompany("TDP")
                                                                .productChanges(productChangesBroadband).build();
                                                ...
                                                if (!newAssignedBillingOffersCableTvList.isEmpty()) {
                                                        ...
                                                        ProductChangeAltaFija productChangesCableTv = ProductChangeAltaFija
                                                                        ...
                                                                        .build();
                                                        newProductAltaFijaCableTv
                                                                        .setProductChanges(productChangesCableTv);
                                                }
                                                ...
                                                NewProductAltaFija newProductAltaFijaAccesories = NewProductAltaFija
                                                                ...
                                                                .temporaryId("temp").baId(baId).accountId(accountId)
                                                                .invoiceCompany("TDP")
                                                                .productChanges(productChangesAccesories).build();
                ...
                if (Boolean.TRUE.equals(isRetail) && statusValidado) {
                        if (StringUtils.isEmpty(this.getStringValueByKeyFromAdditionalDataList(
                                ...
                                return Mono.error(GenesisException.builder()
                                        ...
                                        saleRequest.getAdditionalData(), "NUMERO_CAJA"))) {
                                return Mono.error(GenesisException.builder()
                                                .exceptionId(Constants.BAD_REQUEST_EXCEPTION_ID)
                                                .wildcards(new String[] {
        ...
        private Mono<Sale> mainFunction(Sale saleRequest, PostSalesRequest request, final Boolean[] flgAlta,
                ...
                // ALTA FIJA
                if (commercialOperationReason.equalsIgnoreCase("ALTA") && mainProductType.equalsIgnoreCase("WIRELINE")
                        ...
                        return businessParameterWebClient.getParametersFinanciamientoFija(request.getHeadersMap())
                                        ...
                                        .flatMap(parametersFinanciamientoFija -> processFija(
                                                        parametersFinanciamientoFija, saleRequest, request,
                                                        flgFinanciamiento, cipCode));
                        ...
                        return businessParameterWebClient.getParametersFinanciamientoFija(request.getHeadersMap())
                                        ...
                                        .flatMap(parametersFinanciamientoFija -> wirelineMigrations(
                                                        parametersFinanciamientoFija, request, flgFinanciamiento,
                                                        actionType, cipCode));
                        ...
                        if ((saleRequest.getCommercialOperation().get(0).getOrder() == null || StringUtils.isEmpty(
                                ...
                                Mono<BusinessParametersResponseObjectExt> getBonificacionSim = businessParameterWebClient
                                                .getBonificacionSimcard(saleRequest.getChannel().getId(),
                                                                request.getHeadersMap());
                                ...
                                return Mono.zip(getRiskDomain, salesCharsByCot, getBonificacionSim,
                                                getParametersSimCard, getParametersReasonCode)
                                                .flatMap(tuple -> validationsAndBuildings(tuple.getT1(), tuple.getT2(),
                                                                tuple.getT3(), tuple.getT4(), tuple.getT5(),
                                                                saleRequest, request, sapidSimcard,
                                                                commercialOperationReason, flgCapl, flgCaeq, flgCasi,
                                                                flgAlta, flgFinanciamiento, channelIdRequest,
                                                                customerIdRequest, productOfferingIdRequest, cipCode));
        ...
        private Mono<Sale> validationsAndBuildings(BusinessParametersResponse getRiskDomain,
                        ...
                        String productOfferingIdRequest, String cipCode) {
                ...
                if (flgCapl[0] && !flgCaeq[0] && !flgCasi[0] && !flgAlta[0]) {
                        ...
                        mainRequestProductOrder = this.caeqCommercialOperation(saleRequest, mainRequestProductOrder,
                                        ...
                                        cipCode, sapidSimcard[0], getParameterReasonCode, flgFinanciamiento[0]);
                ...
                return saleRequestUpdated.flatMap(saleItem -> productOrderWebClient
                                .createProductOrder(finalMainRequestProdOrder, request.getHeadersMap(), saleItem)
                                .flatMap(createOrderResponse -> {
                                        ...
                                        if (saleItem.getCommercialOperation().get(0).getWorkOrDeliveryType() != null
                                                ...
                                                saleItem.setAdditionalData(additionalDataAssigments(
                                                                saleItem.getAdditionalData(), saleItem));
                                        }
                                        ...
                                        if (flgCaeq[0] || flgAlta[0] || isMobilePortability) {
                                                ...
                                                return this.callToReserveStockAndCreateQuotation(
                                                                PostSalesRequest.builder().sale(saleItem)
                                                                                .headersMap(request.getHeadersMap())
                                                                                .build(),
                                                                saleItem, flgCasi[0], flgFinanciamiento[0],
                                                                sapidSimcard[0]);
                                        } else {
                                                if (Boolean.TRUE.equals(flgCasi[0])) {
                                                        // Call to Create Quotation Service When CommercialOperation
                                                        // Contains CASI
                                                        ...
                                                        // Case when is Only CAPL
                                                        return salesRepository.save(saleItem).map(r -> {
        ...
        private void assignBillingOffers(List<OfferingType> productOfferings,
                ...
                for (int i = 1; i < productOfferings.size(); i++) {
                        ...
                        String productTypeComponent = this.getStringValueByKeyFromAdditionalDataList(
                                        productOfferings.get(i).getAdditionalData(), "productType"); // Pendiente
                                                                                                     // confirmación de
                                                                                                     // la ruta de
                                                                                                     // referencia del
                                                                                                     // Additional Data
        ...
        private Mono<Sale> processFija(List<BusinessParameterFinanciamientoFijaExt> parametersFinanciamientoFija,
                        Sale saleRequest, PostSalesRequest request, final Boolean[] flgFinanciamiento, String cipCode) {
                ...
                ProductOrderAltaFijaRequest productOrderAltaFijaRequest = ProductOrderAltaFijaRequest.builder()
                                ...
                                .productOfferingId(saleRequest.getCommercialOperation().get(0).getProductOfferings()
                                                .get(0).getId())
        ...
        private Mono<Sale> createOrderFija(CreateProductOrderGeneralRequest mainRequestProductOrder,
                ...
                return saleRequestUpdated.flatMap(saleItem -> {
                        ...
                        return productOrderWebClient
                                        .createProductOrder(mainRequestProductOrder, request.getHeadersMap(), saleItem)
                                        .flatMap(createOrderResponse -> addOrderIntoSale(
                                                        PostSalesRequest.builder().sale(saleItem)
                                                                        .headersMap(request.getHeadersMap()).build(),
                                                        saleItem, flgFinanciamiento, createQuotationFijaRequest,
                                                        createOrderResponse));
                });
        }

        private Mono<Sale> addOrderIntoSale(PostSalesRequest request, Sale saleRequest,
                        final Boolean[] flgFinanciamiento, CreateQuotationRequest createQuotationFijaRequest,
        ...
        private void buildCreateQuotationFijaRequest(CreateQuotationRequest createQuotationRequest,
                 ...
                 * ().get(0) .getAddress().getRegion())
                 * .country(sale.getCommercialOperation().get(0).getWorkOrDeliveryType().
                 * getPlace().get(0) .getAddress().getCountry()) .build();
                 */

                Customer customerQuotation = Customer.builder().id(sale.getRelatedParty().get(0).getCustomerId())
                                ...
                                .creditLimit(sale.getRelatedParty().get(0).getScore().getFinancingCapacity()).build();
                ...
                MoneyAmount totalAmount = MoneyAmount.builder().amount(amountTotalAmount.toString()).units("").build();

                MoneyAmount associatedPlanRecurrentCost = MoneyAmount.builder().amount("0.00").units("PEN").build();
                ...
                if (sale.getCommercialOperation().get(0).getProductOfferings().get(0).getUpFront().getIndicator()
                                .equalsIgnoreCase("N")) {
                        String offeringId = this
                                        .getStringValueByKeyFromAdditionalDataList(
                                                        sale.getCommercialOperation().get(0).getProductOfferings()
                                                                        .get(0).getAdditionalData(),
                                                        "PRODUCT_FOR_INST_FEE")
                                        .concat("_").concat(salesId);

                        com.tdp.ms.sales.model.dto.quotation.Item itemInstallation = com.tdp.ms.sales.model.dto.quotation.Item
                                        .builder().offeringId(offeringId)
                                        ...
                                        .orderActionId(org.apache.commons.lang3.StringUtils
                                                        .chop(sale.getCommercialOperation().get(0).getOrder()
                                                                        .getNewProductsInNewOfferings().get(0)
                                                                        .getProductOrderItemReferenceNumber()))
                                        .build();
                        itemsList.add(itemInstallation);
                }
                // Upgrade de Modem Premium
                if (this.getStringValueByKeyFromAdditionalDataList(
                                sale.getCommercialOperation().get(0).getProductOfferings().get(0).getAdditionalData(),
                                "modemPremium").equalsIgnoreCase("true")) {
                ...
                if (this.getStringValueByKeyFromAdditionalDataList(
                                sale.getCommercialOperation().get(0).getProductOfferings().get(0).getAdditionalData(),
                                "ultraWifi").equalsIgnoreCase("true")) {
                ...
                sale.getCommercialOperation().get(0).getProductOfferings().stream().forEach(productOffering -> {
                        ...
                        if (productSpecificationName.equalsIgnoreCase("TV")) {
                                serviceIdLobConcat[0] = serviceIdLobConcat[0].concat("TV=")
                                                .concat(productOffering.getProductSpecification().get(0)
                                                                .getRefinedProduct().getProductCharacteristics().get(0)
                                                                .getId())
                                                .concat(";");
                        } else if (productSpecificationName.equalsIgnoreCase(Constants.PRODUCT_TYPE_BROADBAND)) {
                                serviceIdLobConcat[0] = serviceIdLobConcat[0].concat("INT=")
                                                .concat(productOffering.getProductSpecification().get(0)
                                                                .getRefinedProduct().getProductCharacteristics().get(0)
                                                                .getId())
                                                .concat(";");
                        } else if (productSpecificationName.equalsIgnoreCase("ShEq")) {
                                serviceIdLobConcat[0] = serviceIdLobConcat[0].concat("EQUP=")
                                                .concat(productOffering.getProductSpecification().get(0)
                                                                .getRefinedProduct().getProductCharacteristics().get(0)
                                                                .getId());
                        }
                ...
                CreateQuotationRequestBody body = CreateQuotationRequestBody.builder()
                                ...
                                .commercialAgreement("N").serviceIdLobConcat(serviceIdLobConcat[0])
                                .customer(customerQuotation)
                                .operationType(getOperationTypeForQuotationRequest(
                                                sale.getCommercialOperation().get(0).getAdditionalData(),
                                                sale.getCommercialOperation().get(0).getReason()))
                                .totalAmount(totalAmount).associatedPlanRecurrentCost(associatedPlanRecurrentCost)
                                .totalCustomerRecurrentCost(totalCustomerRecurrentCost).downPayment(downPayment)
                                .site(site).financialEntity(financialEntity).items(itemsList).channel(channel).build();
        ...
        private String getOperationTypeForQuotationRequest(List<KeyValueType> additionalData, String reason) {
                String isCapl = additionalData.stream().filter(item -> item.getKey().equalsIgnoreCase(Constants.CAPL))
                                .findFirst().orElse(KeyValueType.builder().value(Constants.STRING_FALSE).build())
                                .getValue();
        ...
        private Mono<Sale> creationOrderValidation(Sale saleRequest,
                ...
                if (keyValueType != null && keyValueType.getValue().equalsIgnoreCase("Retail")
                        ...
                        DeviceOffering saleDeviceOffering = saleRequest.getCommercialOperation().get(0)
                                        .getDeviceOffering().get(0);

                        Mono<List<GetSkuResponse>> getSku = getSkuWebClient
                                        .createSku(saleRequest.getChannel().getId(), "default",
                                                        saleDeviceOffering.getSimSpecifications().get(0).getSapid(),
                                                        saleDeviceOffering.getSimSpecifications().get(0).getPrice()
                                                                        .get(0).getValue().doubleValue(),
                                                        operationType, "", saleRequest.getChannel().getStoreId(), "2",
                                                        saleRequest.getChannel().getDealerId(),
                                                        saleDeviceOffering.getSapid(),
                        ...
                        return Mono.zip(getSku, productOrderResponse).map(tuple -> {
                                ...
                                saleRequest.getAdditionalData().add(KeyValueType.builder().key(Constants.DEVICE_SKU)
                                                .value(tuple.getT1().get(0).getDeviceType().equals("mobile_phone")
                                                                ? tuple.getT1().get(0).getSku()
                                                                : tuple.getT1().get(1).getSku())
                                                .build());
                                saleRequest.getAdditionalData().add(KeyValueType.builder().key(Constants.SIM_SKU)
        ...
        private void setReserveReponseInSales(ReserveStockResponse reserveStockResponse, Sale saleRequest) {
                ...
                saleRequest.getCommercialOperation().get(0).getDeviceOffering().forEach(deviceOffering -> deviceOffering
                                .getStock().setReservationId(reserveStockResponse.getId()));
                        ...
                        if (sale.getProductType().equalsIgnoreCase(Constants.WIRELESS)) {
                                ...
                                return businessParameterWebClient
                                                ...
                                                .flatMap(parametersFinanciamientoFija -> {
                                                        this.buildCreateQuotationFijaRequest(createQuotationRequest,
                                                                        request, parametersFinanciamientoFija);

                                                        return quotationWebClient
                                                                        .createQuotation(createQuotationRequest, sale)
                                                                        .flatMap(createQuotationResponse -> {
                                                                                this.setQuotationResponseInSales(
                                                                                                createQuotationResponse,
                                                                                                sale);
                                                                                return salesRepository.save(sale)
                                                                                                .map(r -> {
                                                                                                        this.postSalesEventFlow(
                                                                                                                        request);
                                                                                                        return r;
                                                                                                });
                                                                        });
        ...
        private void buildCreateQuotationRequest(CreateQuotationRequest createQuotationRequest,
                ...
                com.tdp.ms.sales.model.dto.quotation.Item itemEquipment = com.tdp.ms.sales.model.dto.quotation.Item
                                ...
                                .orderActionId(org.apache.commons.lang3.StringUtils.chop(sale.getCommercialOperation()
                                                .get(0).getOrder().getNewProductsInNewOfferings().get(0)
                                                .getProductOrderItemReferenceNumber()))
        ...
        private PortabilityDetailsType buildMobilePortabilityType(Sale saleRequest) {
                ...
                String customerEmail = StringUtils.isEmpty(
                                saleRequest.getProspectContact().get(0).getCharacteristic().getEmailAddress()) ? ""
                                                : saleRequest.getProspectContact().get(0).getCharacteristic()
                                                                .getEmailAddress();
        ...
        private CreateProductOrderGeneralRequest altaCommercialOperation(Sale saleRequest,
                ...
                if (Boolean.TRUE.equals(isRetail) && saleRequest.getStatus().equalsIgnoreCase(Constants.VALIDADO)) {
                        ...
                        FlexAttrValueType deviceSkuAttrValue = FlexAttrValueType.builder().stringValue(deviceSku)
                                        .valueType(Constants.STRING).build();
                        ...
                        FlexAttrType cashierRegisterAttr = FlexAttrType.builder().attrName(Constants.SIM_SKU)
        ...
        public CreateProductOrderGeneralRequest caplCommercialOperation(Sale saleRequest,
                ...
                if (!saleRequest.getCommercialOperation().get(0).getProduct().getProductOffering().getId().equals(
        ...
        public CreateProductOrderGeneralRequest caeqCommercialOperation(Sale saleRequest,
                ...
                ProductChangeCaeq productChangeCaeq = ProductChangeCaeq.builder()
                                .changedContainedProducts(changedContainedProductList).build();
        ...
        public List<FlexAttrType> commonOrderAttributes(Sale saleRequest, final Boolean flgFinanciamiento,
                ...
                if (!StringUtils.isEmpty(deliveryCode)) {
                        FlexAttrValueType deliveryAttrValue = FlexAttrValueType.builder().stringValue(deliveryCode)
                                        .valueType(Constants.STRING).build();
                        FlexAttrType deliveryAttr = FlexAttrType.builder().attrName("DELIVERY_METHOD")
                ...
                if (sendIndicator && flgFinanciamiento) {
                        ...
                        FlexAttrValueType externalFinancialAttrValue = FlexAttrValueType.builder().stringValue("true")
                                        .valueType(Constants.STRING).build();
                        FlexAttrType externalFinancialAttr = FlexAttrType.builder()
                        ...
                        FlexAttrValueType externalFinancialAttrValue = FlexAttrValueType.builder()
                                        .stringValue(Constants.STRING_FALSE).valueType(Constants.STRING).build();
                        FlexAttrType externalFinancialAttr = FlexAttrType.builder()
                                        .attrName(Constants.IS_EXTERNAL_FINANCING)
                                        .flexAttrValue(externalFinancialAttrValue).build();
                        commonOrderAttributes.add(externalFinancialAttr);
        ...
        private void setChangedContainedProductProductId(ChangedContainedProduct changedContainedProduct,
                ...
                productRelationShip.stream()
                                ...
                                .findFirst()
                                .ifPresent(item -> item.getProduct().getProductRelationship().stream().filter(
                                                pr -> pr.getProduct().getDescription().equalsIgnoreCase("Device"))
        ...
        private ReserveStockRequest buildReserveStockRequest(ReserveStockRequest request, Sale sale,
                ...
                // Equipment Item
                Item item1 = Item.builder().id(sale.getCommercialOperation().get(0).getDeviceOffering().stream()
                                .filter(item -> !item.getDeviceType().equalsIgnoreCase("SIM")).findFirst()
                                .orElse(DeviceOffering.builder().sapid(null).build()).getSapid()).type("IMEI").build();
                ...
                if (sale.getCommercialOperation().get(0).getDeviceOffering().size() > 1) {
                        // SIM Item
                        Item item2 = Item.builder().id(sapidSimcardBp).type("IMEI").build();
                ...
                Order order = Order.builder()
                                ...
                                .id(sale.getCommercialOperation().get(0).getOrder().getProductOrderId()).build();
        ...
        private Mono<Sale> wirelineMigrations(List<BusinessParameterFinanciamientoFijaExt> parametersFinanciamientoFija,
                        PostSalesRequest request, final Boolean[] flgFinanciamiento, String actionType,
                        String cipCode) {
        ...
        private ServiceabilityInfoType buildServiceabilityInfoType(PostSalesRequest request) {
                ...
                return ServiceabilityInfoType.builder()
                                ...
                                .offers(serviceabilityOffersList).commercialZone(commercialZone).build();
        }
        ...
        private List<NewProductMigracionFija> broadbandPlanBAF(List<MigrationComponent> migrationComponentList,
                ...
                productOfferings.get(0).getProductSpecification().stream().filter(
                                ...
                                .findFirst().ifPresent(item -> {
                                        characteristicValue[0] = item.getProductPrice().get(3).getAdditionalData()
                                                        .stream()
                ...
                productOfferings.forEach(productOffering -> {
                        if (productOffering.getProductSpecification().get(0).getProductType().equalsIgnoreCase("sva")) {
                                String productType = getStringValueByKeyFromAdditionalDataList(
                                                productOffering.getAdditionalData(), "productType");
