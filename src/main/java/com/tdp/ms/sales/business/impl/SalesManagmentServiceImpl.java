...
public class SalesManagmentServiceImpl implements SalesManagmentService {
        ...
        private void callWebClientReceptor(PostSalesRequest request, String eventFlowCode) {
                // Llamada a receptor
                webClientReceptor.register(
                                ReceptorRequest.builder().businessId(request.getSale().getSalesId())
        ...
        private void buildOrderAttributesListAltaFija(List<FlexAttrType> altaFijaOrderAttributesList, Sale saleRequest,
                ...
                String upFrontIndAttrStringValue = saleRequest.getCommercialOperation().get(0)
                                .getProductOfferings() != null
        ...
        private void buildServiceAvailabilityAltaFija(Sale saleRequest,
                ...
                if (mainOffering != null) {
                        mainOffering.getProductSpecification().stream().forEach(item -> {
                ...
                Number offerPriority = saleRequest.getCommercialOperation().get(0).getServiceAvailability().getOffers()
                                .get(0).getPriority();
                saleRequest.getCommercialOperation().get(0).getServiceAvailability().getOffers().get(0).getServices()
                                .stream().forEach(serviceOffer -> {
                                        ...
                                        if (serviceAbilityType.equalsIgnoreCase(Constants.PRODUCT_TYPE_LANDLINE)
                                                ...
                                                ProductLineType productOfferLandline1 = ProductLineType.builder()
                                                                ...
                                                                .networkTechnology(this
                                                                                .getStringValueByKeyFromAdditionalDataList(
                                                                                                saleRequest.getCommercialOperation()
                                                                                                                .get(0)
                                                                                                                .getServiceAvailability()
                                                                                                                .getAdditionalData(),
                                                                                                "networkAccessTechnologyLandline"))
                                                                .serviceTechnology(this
                                                                                .getStringValueByKeyFromAdditionalDataList(
                                                                                                saleRequest.getCommercialOperation()
                                                                                                                .get(0)
                                                                                                                .getServiceAvailability()
        ...
        private List<NewProductAltaFija> buildNewProductsAltaFijaList(Sale saleRequest,
                ...
                if (saleRequest.getCommercialOperation().get(0).getProductOfferings() != null
                        ...
                        saleRequest.getCommercialOperation().get(0).getProductOfferings().get(0)
                                        .getProductSpecification().stream().forEach(productSpecification -> {
        ...
        private Mono<Sale> retryRequest(PostSalesRequest request, Sale sale, Boolean flgCaeq, Boolean flgAlta,
                ...
                if (sale.getCommercialOperation().get(0).getOrder() != null
                                && (sale.getCommercialOperation().get(0).getDeviceOffering() == null
                                                || sale.getCommercialOperation().get(0).getDeviceOffering().get(0)
                                                                .getStock() == null
                                                || StringUtils.isEmpty(sale.getCommercialOperation().get(0)
                                                                .getDeviceOffering().get(0).getStock()
                                                                .getReservationId()))) { // Retry from Reservation

                        // Call to Reserve Stock Service When Commercial Operation include CAEQ
                        if (flgCaeq || flgAlta) {

                                return this.callToReserveStockAndCreateQuotation(
                                                PostSalesRequest.builder().sale(sale)
                                                                .headersMap(request.getHeadersMap()).build(),
                                                sale, flgCasi, flgFinanciamiento, sapidSimcard);
                        } else {
                                if (Boolean.TRUE.equals(flgCasi)) {

                                        // Call to Create Quotation Service When CommercialOperation Contains CASI
                                        return this.callToCreateQuotation(
                                                        PostSalesRequest.builder().sale(sale)
                                                                        .headersMap(request.getHeadersMap()).build(),
                                                        sale, true, flgFinanciamiento);
                                } else {
                                        // Case when is Only CAPL
                                        return salesRepository.save(sale).map(r -> {
                                                this.postSalesEventFlow(PostSalesRequest.builder().sale(sale)
                                                                .headersMap(request.getHeadersMap()).build());
                                                return r;
                                        });
                                }
                        ...
                        return this.callToCreateQuotation(PostSalesRequest.builder().sale(sale)
                                        .headersMap(request.getHeadersMap()).build(), sale, flgCasi, flgFinanciamiento);
                }
        ...
        public Mono<Sale> post(PostSalesRequest request) {
                ...
                if (Boolean.TRUE.equals(isRetail) && statusValidado) {
                        if (saleRequest.getCommercialOperation().get(0).getDeviceOffering() != null
                                ...
                                DeviceOffering deviceOfferingSim = saleRequest.getCommercialOperation().get(0)
                                ...
                                if (deviceOfferingSim != null
                                                && StringUtils.isEmpty(this.getStringValueByKeyFromAdditionalDataList(
                                ...
                                DeviceOffering deviceOfferingSmartphone = saleRequest.getCommercialOperation().get(0)
                                                .getDeviceOffering().stream()
                                                .filter(item -> !item.getDeviceType()
                                                                .equalsIgnoreCase(Constants.DEVICE_TYPE_SIM))
                                                .findFirst().orElse(null);
                        ...
                        if (StringUtils.isEmpty(this.getStringValueByKeyFromAdditionalDataList(
                                ...
                                return Mono.error(GenesisException.builder()
                                                ...
                                                .build());
                        } else if (StringUtils.isEmpty(this.getStringValueByKeyFromAdditionalDataList(
                ...
                flgFinanciamiento[0] = setFinancingFlag(
                ...
                return salesRepository.findBySalesId(saleRequest.getSalesId())
                                ...
                                .flatMap(saleItem -> {
                                        if (saleItem.getSalesId() == null || saleItem.getCommercialOperation() == null
                                                        || saleItem.getCommercialOperation().get(0)
                                                                        .getOrder() == null) {
                                                return mainFunction(saleRequest, request, flgAlta, flgCapl, flgCaeq,
                                                                flgCasi, flgFinanciamiento, isRetail, sapidSimcard);
                                        }
        ...
        private Mono<Sale> mainFunction(Sale saleRequest, PostSalesRequest request, final Boolean[] flgAlta,
                ...
                boolean sendIndicator = isNecessaryToSendVariablesInOrderCreation(
                                request.getSale().getCommercialOperation().get(0));
                String cipCode = getCipCode(saleRequest.getPaymenType(), sendIndicator, flgFinanciamiento[0]);

                // ALTA FIJA
                if (commercialOperationReason.equalsIgnoreCase("ALTA")
                                && mainProductType.equalsIgnoreCase(Constants.WIRELINE)
                                && saleRequest.getCommercialOperation().get(0).getAction()
                                                .equalsIgnoreCase("PROVIDE")) {
                        ...
                        return businessParameterWebClient.getParametersFinanciamientoFija(request.getHeadersMap())
                                        ...
                                        .flatMap(parametersFinanciamientoFija -> processFija(
                                                        parametersFinanciamientoFija, saleRequest, request, isRetail,
                                                        cipCode));
                        ...
                        return businessParameterWebClient.getParametersFinanciamientoFija(request.getHeadersMap())
                                        ...
                                        .map(bpFinanciamientoFijaData -> bpFinanciamientoFijaData.get(0))
                                        .map(BusinessParameterFinanciamientoFijaData::getExt)
                                        .flatMap(parametersFinanciamientoFija -> wirelineMigrations(
                                                        parametersFinanciamientoFija, request, actionType, isRetail,
                                                        cipCode));
                        ...
                        if ((saleRequest.getCommercialOperation().get(0).getOrder() == null || StringUtils.isEmpty(
                                        saleRequest.getCommercialOperation().get(0).getOrder().getProductOrderId()))
                                ...
                                String productOfferingIdRequest = saleRequest.getCommercialOperation().get(0)
                                                .getProductOfferings().get(0).getId();

                                // Getting Characteristics By Main Commercial Operation - Check if is used it to
                                // remove
                                Mono<List<BusinessParameterExt>> salesCharsByCot = businessParameterWebClient
                                                .getSalesCharacteristicsByCommercialOperationType(
                                                                GetSalesCharacteristicsRequest.builder()
                                                                                .commercialOperationType(
                                                                                                commercialOperationReason)
                                ...
                                return Mono.zip(getRiskDomain, salesCharsByCot, getBonificacionSim,
                                                getParametersSimCard, getParametersReasonCode).flatMap(tuple -> {
                                                        try {
                                                                return validationsAndBuildings(tuple.getT1(),
                                                                                tuple.getT2(), tuple.getT3(),
                                                                                tuple.getT4(), tuple.getT5(),
                                                                                saleRequest, request, sapidSimcard,
                                                                                commercialOperationReason, flgCapl,
                                                                                flgCaeq, flgCasi, flgAlta,
                                                                                flgFinanciamiento, channelIdRequest,
                                                                                customerIdRequest,
        ...
        private Boolean deviceOfferingIsNullOrEmpty(Sale saleRequest) {
                if (saleRequest.getCommercialOperation().get(0).getDeviceOffering() == null
                                || saleRequest.getCommercialOperation().get(0).getDeviceOffering().isEmpty()) {
                        return true;
                } else if (saleRequest.getCommercialOperation().get(0).getDeviceOffering().get(0).getStock() == null) {
                        return true;
        ...
        private String getCipCode(PaymentType paymentType, boolean sendIndicator, final boolean flgFinanciamiento) {
                ...
                String paymentMediumLabelValue = this.getStringValueByKeyFromAdditionalDataList(
        ...
        private Mono<Sale> validationsAndBuildings(BusinessParametersResponse getRiskDomain,
                        ...
                        BusinessParametersReasonCode getParameterReasonCode, Sale saleRequest, PostSalesRequest request,
                        final String[] sapidSimcard, String commercialOperationReason, final Boolean[] flgCapl,
                        final Boolean[] flgCaeq, final Boolean[] flgCasi, final Boolean[] flgAlta,
                        final Boolean[] flgFinanciamiento, String channelIdRequest, String customerIdRequest,
                        String productOfferingIdRequest, Boolean isRetail, String cipCode) throws ParseException {

                if (!getRiskDomain.getData().isEmpty() && getRiskDomain.getData().get(0).getActive()) {
                        // if it is a risk domain, cancel operation
                        return Mono.error(GenesisException.builder().exceptionId("SVR1000")
                ...
                sapidSimcard[0] = getStringValueFromBusinessParameterDataListByKeyAndActiveTrue(
                                getParametersSimCard.getData(), "sapid");
                ...
                if (flgCapl[0] && !flgCaeq[0] && !flgCasi[0] && !flgAlta[0]) {
                        ...
                        mainRequestProductOrder = this.caplCommercialOperation(saleRequest, mainRequestProductOrder,
                                        ...
                                        getBonificacionSim, flgFinanciamiento[0]);
                        ...
                        mainRequestProductOrder = this.caeqCommercialOperation(saleRequest, mainRequestProductOrder,
                                        flgCasi[0], channelIdRequest, customerIdRequest, productOfferingIdRequest,
                                        cipCode, sapidSimcard[0], getParameterReasonCode, getBonificacionSim,
                                        flgFinanciamiento[0]);
                        ...
                        mainRequestProductOrder = this.altaCommercialOperation(saleRequest, mainRequestProductOrder,
                                        channelIdRequest, customerIdRequest, productOfferingIdRequest, cipCode,
                                        getBonificacionSim, sapidSimcard[0], isMobilePortability, flgCasi[0],
                                        flgFinanciamiento[0]);
                }
                ...
                if (saleRequest.getCommercialOperation().get(0).getDeviceOffering() != null
                        ...
                        return productOrderWebClient.createProductOrder(finalMainRequestProdOrder,
                                        request.getHeadersMap(), saleRequest).flatMap(createOrderResponse -> {
                                                ...
                                                saleRequest.getCommercialOperation().get(0).setOrder(
                                                                createOrderResponse.getCreateProductOrderResponse());
                                                ...
                                                if (saleRequest.getCommercialOperation().get(0)
                                                                .getWorkOrDeliveryType() != null
                                                                && !StringUtils.isEmpty(saleRequest
                                                                                .getCommercialOperation().get(0)
                                                                                .getWorkOrDeliveryType()
                                                                                .getMediumDelivery())
                                                                && saleRequest.getCommercialOperation().get(0)
                                                                                .getWorkOrDeliveryType()
                                                                                .getMediumDelivery()
                                                                                .equalsIgnoreCase("Tienda")) {
                                                        saleRequest.setAdditionalData(additionalDataAssigments(
                                                                        saleRequest.getAdditionalData(), saleRequest));
                                                }
                                                ...
                                                if (flgCaeq[0] || flgAlta[0] || isMobilePortability) {
                                                        ...
                                                        return this.callToReserveStockAndCreateQuotation(
                                                                        PostSalesRequest.builder().sale(saleRequest)
                                                                                        .headersMap(request
                                                                                                        .getHeadersMap())
                                                                                        .build(),
                                                        ...
                                                        if (Boolean.TRUE.equals(flgCasi[0])) {
                                                                // Call to Create Quotation Service When
                                                                // CommercialOperation Contains CASI
                                                                return this.callToCreateQuotation(PostSalesRequest
                                                                                .builder().sale(saleRequest)
                                                                                .headersMap(request.getHeadersMap())
                                                                                .build(), saleRequest, flgCasi[0],
                                                                                flgFinanciamiento[0]);
                                                        } else {
                                                                // Case when is Only CAPL
                                                                return salesRepository.save(saleRequest).map(r -> {
                                                                        this.postSalesEventFlow(PostSalesRequest
                                                                                        .builder().sale(saleRequest)
                                                                                        .headersMap(request
                                                                                                        .getHeadersMap())
                                                                                        .build());
        ...
        private boolean isNecessaryToSendVariablesInOrderCreation(CommercialOperationType commercialOperationType) {
                ...
                if ((reason.equalsIgnoreCase(Constants.CAEQ) || reason.equalsIgnoreCase(Constants.CAPL)
        ...
        private Mono<Sale> processFija(List<BusinessParameterFinanciamientoFijaExt> parametersFinanciamientoFija,
                        Sale saleRequest, PostSalesRequest request, Boolean isRetail, String cipCode) {
                ...
                this.buildCreateQuotationFijaRequest(createQuotationFijaRequest, request, parametersFinanciamientoFija);

                LOG.info("Alta Fija Sales has financing: " + (createQuotationFijaRequest.getBody() != null));
                LOG.info("Create Quotation Fija Request without order info: "
                                .concat(new Gson().toJson(createQuotationFijaRequest.getBody())));
                ...
                altaFijaRequest.setAppointmentId(
                                saleRequest.getCommercialOperation().get(0).getWorkOrDeliveryType() != null
                                                && saleRequest.getCommercialOperation().get(0).getWorkOrDeliveryType()
                                                                .getWorkOrder() != null
                                                && saleRequest.getCommercialOperation().get(0).getWorkOrDeliveryType()
                                                                .getWorkOrder().getWorkforceTeams() != null
                                                                                ? saleRequest.getCommercialOperation()
                                                                                                .get(0)
                                                                                                .getWorkOrDeliveryType()
                                                                                                .getWorkOrder()
                ...
                boolean sendInd = isNecessaryToSendVariablesInOrderCreation(
                                request.getSale().getCommercialOperation().get(0));
                altaFijaRequest.setUpfrontIndicator(sendInd ? setUpFrontIndicator(saleRequest.getProductType()) : null);
                ...
                return createOrderFija(mainRequestProductOrder, request, saleRequest, createQuotationFijaRequest,
                                isRetail);
        }

        private Mono<Sale> createOrderFija(CreateProductOrderGeneralRequest mainRequestProductOrder,
                        PostSalesRequest request, Sale saleRequest, CreateQuotationRequest createQuotationFijaRequest,
                        Boolean isRetail) {
                ...
                if (saleRequest.getCommercialOperation().get(0).getDeviceOffering() != null
                        ...
                        return productOrderWebClient
                                        .createProductOrder(mainRequestProductOrder, request.getHeadersMap(),
                                                        saleRequest)
                                        .flatMap(createOrderResponse -> addOrderIntoSale(
                                                        PostSalesRequest.builder().sale(saleRequest)
                                                                        .headersMap(request.getHeadersMap()).build(),
        ...
        private Mono<Sale> addOrderIntoSale(PostSalesRequest request, Sale saleRequest,
                        CreateQuotationRequest createQuotationFijaRequest, ProductorderResponse createOrderResponse) {
                LOG.info("Create Order Response: " + new Gson().toJson(createOrderResponse));
                // Adding Order info to sales
                saleRequest.getCommercialOperation().get(0)
                                .setOrder(createOrderResponse.getCreateProductOrderResponse()); // Pending evaluate this
                                                                                                // setter for MT

                if (validateNegotiation(saleRequest.getAdditionalData(), saleRequest.getIdentityValidations())) {
                        saleRequest.setStatus(Constants.NEGOCIACION);
                } else if (!StringUtils
                ...
                if (createQuotationFijaRequest.getBody() != null) {
                        ...
                        return quotationWebClient.createQuotation(createQuotationFijaRequest, saleRequest)
                                        .flatMap(createQuotationResponse -> salesRepository.save(saleRequest).map(r -> {
                                                this.postSalesEventFlow(request);
                                                return r;
                                        }));
                } else {
        ...
        private void buildCreateQuotationFijaRequest(CreateQuotationRequest createQuotationRequest,
                        PostSalesRequest salesRequest, List<BusinessParameterFinanciamientoFijaExt> bpFinanciamiento) {
                ...
                if (sale.getProductType().equalsIgnoreCase(Constants.WIRELINE)) {
                        ...
                        mainCommercialOperation = sale.getCommercialOperation().stream()
                                        .filter(item -> this.getStringValueByKeyFromAdditionalDataList(
                                                        item.getAdditionalData(), Constants.PRODUCT_TYPE)
                                                        .equalsIgnoreCase(Constants.WIRELINE))
                                        .findFirst().orElse(new CommercialOperationType());
                }

                // Conditional to call Create Quotation
                // Financiamiento de Instalación
                OfferingType offeringType1 = mainCommercialOperation.getProductOfferings().stream()
                                .filter(item -> item.getUpFront().getIndicator().equalsIgnoreCase("N")).findFirst()
                                .orElse(null);
                // Upgrade de Modem Premium
                OfferingType offeringType2 = mainCommercialOperation.getProductOfferings().stream().filter(item -> this
                                .getStringValueByKeyFromAdditionalDataList(item.getAdditionalData(), "modemPremium")
                                .equalsIgnoreCase("true")).findFirst().orElse(null);
                // Ultra Wifi
                OfferingType offeringType3 = mainCommercialOperation.getProductOfferings().stream().filter(item -> this
                                .getStringValueByKeyFromAdditionalDataList(item.getAdditionalData(), "ultraWifi")
                                .equalsIgnoreCase("true")).findFirst().orElse(null);
                if (offeringType1 == null && offeringType2 == null && offeringType3 == null) {
                        createQuotationRequest.setBody(null);
                } else {
                        final String[] email = { null };
                        sale.getProspectContact().stream()
                                        .filter(item -> item.getMediumType()
                                                        .equalsIgnoreCase(Constants.MEDIUM_TYPE_EMAIL_ADDRESS))
                                        .findFirst()
                        ...
                        LegalId legalId = LegalId.builder().country("PE").isPrimary("true")
                                        .nationalId(sale.getRelatedParty().get(0).getNationalId())
                                        .nationalIdType(sale.getRelatedParty().get(0).getNationalIdType()).build();

                        /*
                         * Se borra el campo a pedido de Lincoln Address address = Address .builder()
                         * .streetNr(mainCommercialOperation.getWorkOrDeliveryType().getPlace().get(0).
                         * getAddress() .getStreetNr())
                         * .streetName(mainCommercialOperation.getWorkOrDeliveryType().getPlace().get(0)
                         * .getAddress() .getStreetName())
                         * .streetType(mainCommercialOperation.getWorkOrDeliveryType().getPlace().get(0)
                         * .getAddress() .getStreetType())
                         * .locality(this.getStringValueByKeyFromAdditionalDataList(
                         * mainCommercialOperation
                         * .getWorkOrDeliveryType().getPlace().get(0).getAdditionalData(), "locality"))
                         * .city(mainCommercialOperation.getWorkOrDeliveryType().getPlace().get(0).
                         * getAddress() .getCity())
                         * .stateOrProvince(mainCommercialOperation.getWorkOrDeliveryType().getPlace().
                         * get(0) .getAddress().getStateOrProvince())
                         ...
                         * .getAddress().getCountry()) .build();
                         */

                        Customer customerQuotation = Customer.builder()
                                        ...
                                        .segment(this.getStringValueByKeyFromAdditionalDataList(
                                                        sale.getAdditionalData(), "customerTypeCode"))
                                        .subsegment(this.getStringValueByKeyFromAdditionalDataList(
                                                        sale.getAdditionalData(), "customerSubTypeCode"))
                                        .contactMedia(contactMediumList).legalId(legalId)
                                        .creditLimit(sale.getRelatedParty().get(0).getScore().getFinancingCapacity())
                                        .build();

                        MoneyAmount associatedPlanRecurrentCost = MoneyAmount.builder().amount("0.00").units("PEN")
                                        .build();

                        MoneyAmount totalCustomerRecurrentCost = MoneyAmount.builder()
                                        .amount(mainCommercialOperation.getProductOfferings().get(0)
                                                        .getProductOfferingPrice().get(0).getMaxPrice()
                                                        .getAmount() == null
                                                                        ? "0"
                                                                        : mainCommercialOperation.getProductOfferings()
                                                                                        .get(0)
                        ...
                        MoneyAmount downPayment = MoneyAmount.builder().amount("0.00").units("PEN").build();
                        ...
                        if (offeringType1 != null) {
                                ...
                                String productForInstFee = this.getStringValueByKeyFromAdditionalDataList(
                                                offeringType1.getAdditionalData(), "PRODUCT_FOR_INST_FEE");
                                String offeringId = productForInstFee.concat("_").concat(salesId);
                                MoneyAmount totalCostAmount = MoneyAmount.builder()
                                ...
                                com.tdp.ms.sales.model.dto.quotation.Item itemInstallation = com.tdp.ms.sales.model.dto.quotation.Item
                                                .builder().offeringId(offeringId).orderActionId("") // Value mapping
                                                                                                    // moved to
                                                                                                    // addOrderInfoToCreateQuotationFijaRequest
                                                                                                    // method
                                                ...
                                                .totalCost(totalCostAmount).build();
                                itemsList.add(itemInstallation);
                        }
                        // Upgrade de Modem Premium
                        if (offeringType2 != null) {
                                LOG.info("Create Quotation has Upgrade Modem Premium Item");
                                String offeringId = "EQUP".concat("_").concat(salesId);

                                MoneyAmount totalCostAmount = MoneyAmount.builder()
                                                .amount(offeringType2.getProductSpecification().get(0).getProductPrice()
                                                                .get(0).getPrice().getAmount().toString())
                                                .build();
                        ...
                        if (offeringType3 != null) {
                                ...
                                String offeringId = "BB".concat("_").concat(salesId);
                        ...
                        itemsList.forEach(item -> {
                                amountTotalAmount[0] = amountTotalAmount[0]
                                                + Double.parseDouble(item.getTotalCost().getAmount());
                        });
                        MoneyAmount totalAmount = MoneyAmount.builder().amount(amountTotalAmount[0].toString())
                                        .units("PEN").build();
                        ...
                        CreateQuotationRequestBody body = CreateQuotationRequestBody.builder().orderId("") // Value
                                                                                                           // mapping
                                                                                                           // moved to
                                                                                                           // addOrderInfoToCreateQuotationFijaRequest
                                                                                                           // method
                                        ...
                                        .commercialAgreement("N").serviceIdLobConcat("") // Value mapping moved to
                                                                                         // addOrderInfoToCreateQuotationFijaRequest
                                                                                         // method
                                        .customer(customerQuotation).operationType(operationType)
                                        .totalAmount(totalAmount)
                                        .associatedPlanRecurrentCost(associatedPlanRecurrentCost)
                                        .totalCustomerRecurrentCost(totalCustomerRecurrentCost).downPayment(downPayment)
                                        .site(site).financialEntity(financialEntity).items(itemsList).channel(channel)
                                        .build();
        ...
        private void addOrderInfoToCreateQuotationFijaRequest(CreateQuotationRequest createQuotationRequest,
                ...
                // Attributes only to Fija FEMS-4419, pending evaluate if Migration Case also
                // apply
                final String[] serviceIdLobConcat = { "" };

                CommercialOperationType finalMainCommercialOperation = mainCommercialOperation;
                mainCommercialOperation.getProductOfferings().get(0).getProductSpecification().stream() // Pending
                                                                                                        // evaluate
                                                                                                        // productOffering
                                                                                                        // for Alta only
                                                                                                        // SVAs case
                                .forEach(productSpecification -> {
                                        ...
                                        if (productSpecificationType
                                                        .equalsIgnoreCase(Constants.PRODUCT_TYPE_CABLE_TV)) {
                                                serviceIdLobConcat[0] = serviceIdLobConcat[0].concat("TV=").concat(this
                                                                .getServiceIdFromProductConfigurationByLineOfBussinessType(
                                                                                finalMainCommercialOperation,
                                                                                Constants.PRODUCT_TYPE_CABLE_TV))
                                                                .concat(";");
                                        } else if (productSpecificationType
                                                        .equalsIgnoreCase(Constants.PRODUCT_TYPE_BROADBAND)) {
                                                serviceIdLobConcat[0] = serviceIdLobConcat[0].concat("INT=").concat(this
                                                                .getServiceIdFromProductConfigurationByLineOfBussinessType(
                                                                                finalMainCommercialOperation,
                                                                                Constants.PRODUCT_TYPE_BROADBAND))
                                                                .concat(";");
                                        } else if (productSpecificationType
                                                        .equalsIgnoreCase(Constants.PRODUCT_TYPE_LANDLINE)) {
                                                serviceIdLobConcat[0] = serviceIdLobConcat[0].concat("VOIC=").concat(
                                                                this.getServiceIdFromProductConfigurationByLineOfBussinessType(
                                                                                finalMainCommercialOperation,
                                                                                Constants.PRODUCT_TYPE_LANDLINE))
                                                                .concat(";");
                                        } else if (productSpecificationType
                                                        .equalsIgnoreCase(Constants.PRODUCT_TYPE_DEVICE)) {
                                                serviceIdLobConcat[0] = serviceIdLobConcat[0].concat("EQUP=").concat(
                                                                this.getServiceIdFromProductConfigurationByLineOfBussinessType(
                                                                                finalMainCommercialOperation,
                                                                                Constants.PRODUCT_TYPE_DEVICE));
                                        }
                                });

                createQuotationRequest.getBody().setServiceIdLobConcat(serviceIdLobConcat[0]);

                createQuotationRequest.getBody().getItems().stream().forEach(item -> {
                        item.setOrderActionId(org.apache.commons.lang3.StringUtils.chop(
                                        finalMainCommercialOperation.getOrder().getProductOrderReferenceNumber()));
                });

                createQuotationRequest.getBody().setOrderId("TEF" + String.format("%012d",
                                new BigInteger(mainCommercialOperation.getOrder().getProductOrderId())));
        }
        ...
        private String getOperationTypeForQuotationRequest(List<KeyValueType> additionalData, String reason) {
                String isCapl = additionalData.stream().filter(item -> item.getKey().equalsIgnoreCase(Constants.CAPL))
                                .findFirst().orElse(KeyValueType.builder().value("false").build()).getValue();
        ...
        private String getServiceIdFromProductConfigurationByLineOfBussinessType(
                ...
                NewProductInNewOfferingInstanceConfigurationType emptyProduct = NewProductInNewOfferingInstanceConfigurationType
                                .builder()
                                .productConfiguration(TopLevelProductConfigurationType.builder().serviceId("").build())
                                .build();

                String serviceId = commercialOperation.getOrder().getNewProductsInNewOfferings().stream()
                                .filter(item -> item.getProductConfiguration().getLineOfBusinessType()
                                                .equalsIgnoreCase(lineOfBusinessType))
                                .findFirst().orElse(emptyProduct).getProductConfiguration().getServiceId();
        ...
        private Mono<Sale> callToReserveStockAndCreateQuotation(PostSalesRequest request, Sale saleRequest,
                        Boolean flgCasi, Boolean flgFinanciamiento, String sapidSimcard) {
                ...
                reserveStockRequest = this.buildReserveStockRequest(reserveStockRequest, saleRequest,
                                saleRequest.getCommercialOperation().get(0).getOrder(), sapidSimcard);
                ...
                return stockWebClient.reserveStock(reserveStockRequest, request.getHeadersMap(), saleRequest)
                                .flatMap(reserveStockResponse -> {
                                        ...
                                        // Call to Create Quotation Service When CommercialOperation Contains CAEQ
                                        return this.callToCreateQuotation(request, saleRequest, flgCasi,
                                                        flgFinanciamiento);
                                });
        }
        ...
        private void setReserveReponseInSales(ReserveStockResponse reserveStockResponse, Sale saleRequest) {
                ...
                if (saleRequest.getCommercialOperation().get(0).getDeviceOffering().get(0)
                                .getAdditionalData() == null) {
                        saleRequest.getCommercialOperation().get(0).getDeviceOffering().get(0)
                                        .setAdditionalData(new ArrayList<>());
                }

                saleRequest.getCommercialOperation().get(0).getDeviceOffering().get(0).getAdditionalData().add(dateKv);

                saleRequest.getCommercialOperation().get(0).getDeviceOffering().forEach(deviceOffering -> {
                        if (deviceOffering.getStock() == null) {
                                deviceOffering.setStock(StockType.builder().reservationId(reserveStockResponse.getId())
                                                .build());
                        } else {
                ...
                saleRequest.getCommercialOperation().get(0).getDeviceOffering().get(0).getStock()
                                .setAmount(reserveStockResponse.getItems().get(0).getAmount());

                saleRequest.getCommercialOperation().get(0).getDeviceOffering().get(0).getStock()
                                .setSite(reserveStockResponse.getItems().get(0).getSite());
        }
        ...
        private void setQuotationResponseInSales(CreateQuotationResponse quotationResponse, Sale sale) {
                ...
                KeyValueType keyValueAmountQuotation = KeyValueType.builder().key("amountPerInstalment")
                                .value(quotationResponse.getAmountPerInstalment().toString()).build();
        ...
        private void buildCreateQuotationRequest(CreateQuotationRequest createQuotationRequest,
                ...
                /*
                 * Se borra el campo address, a pedido de Lincoln Address address = Address
                 * .builder()
                 * .streetName(sale.getCommercialOperation().get(0).getWorkOrDeliveryType().
                 * getPlace().get(0).getAddress() .getStreetName())
                 * .streetNr(sale.getCommercialOperation().get(0).getWorkOrDeliveryType().
                 * getPlace().get(0).getAddress() .getStreetNr())
                 * 
                 * 
                 * .locality(this.getStringValueByKeyFromAdditionalDataList(sale.
                 * getCommercialOperation().get(0)
                 * .getWorkOrDeliveryType().getPlace().get(0).getAdditionalData(), "locality"))
                 * .streetType(sale.getCommercialOperation().get(0).getWorkOrDeliveryType().
                 * getPlace().get(0).getAddress() .getStreetType())
                 * .city(sale.getCommercialOperation().get(0).getWorkOrDeliveryType().getPlace()
                 * .get(0).getAddress() .getCity())
                 * .stateOrProvince(sale.getCommercialOperation().get(0).getWorkOrDeliveryType()
                 * .getPlace().get(0) .getAddress().getStateOrProvince())
                 * .country(sale.getCommercialOperation().get(0).getWorkOrDeliveryType().
                 * getPlace().get(0) .getAddress().getCountry())
                 * .region(sale.getCommercialOperation().get(0).getWorkOrDeliveryType().getPlace
                 * ().get(0) .getAddress().getRegion()) .build();
                 */
                ...
                Double simAmount = sale.getCommercialOperation().get(0).getDeviceOffering().size() > 1
                                ? sale.getCommercialOperation().get(0).getDeviceOffering().get(1).getSimSpecifications()
                                                .get(0).getPrice().get(0).getValue().doubleValue()
                                : 0.0;

                Number amountTotalAmount = sale.getCommercialOperation().get(0).getDeviceOffering().get(0).getOffers()
                                ...
                                .doubleValue() - simAmount;

                MoneyAmount totalAmount = MoneyAmount.builder().units("PEN").amount(amountTotalAmount.toString())
                                .build();

                MoneyAmount associatedPlanRecurrentCost = MoneyAmount.builder().units("PEN").amount("0.00").build();

                MoneyAmount totalCustomerRecurrentCost = MoneyAmount.builder().units("PEN")
                                .amount(sale.getCommercialOperation().get(0).getProductOfferings().get(0)
                                                .getProductOfferingPrice().get(0).getMaxPrice().getAmount() == null
                                                                ? "0"
                                                                : sale.getCommercialOperation().get(0)
                                                                                .getProductOfferings().get(0)
                                                                                .getProductOfferingPrice().get(0)
                                                                                .getMaxPrice().getAmount().toString())
                                .build();

                MoneyAmount downPayment = MoneyAmount.builder()
                                .amount(sale.getCommercialOperation().get(0).getDeviceOffering().get(0).getOffers()
                                                .get(0).getBillingOfferings().get(0).getCommitmentPeriods().get(0)
                ...
                MoneyAmount totalCost = MoneyAmount.builder().units("PEN")
                                .amount(sale.getCommercialOperation().get(0).getDeviceOffering().get(0).getOffers()
                                                .get(0).getBillingOfferings().get(0).getCommitmentPeriods().get(0)
                ...
                double taxExcludedAmountDouble = sale.getCommercialOperation().get(0).getDeviceOffering().get(0)
                ...
                com.tdp.ms.sales.model.dto.quotation.Item itemEquipment = com.tdp.ms.sales.model.dto.quotation.Item
                                ...
                                .offeringId("EQUIP_FE".concat(
                                                sale.getCommercialOperation().get(0).getProduct().getPublicId()))
                                .totalCost(totalCost)
                                .orderActionId(org.apache.commons.lang3.StringUtils.chop(sale.getCommercialOperation()
                                                .get(0).getOrder().getProductOrderReferenceNumber()))
                                .publicId(sale.getCommercialOperation().get(0).getProduct().getPublicId()).build();
                itemsList.add(itemEquipment);

                if (flgCasi) { // sale.getCommercialOperation().get(0).getDeviceOffering().size() == 2
                        MoneyAmount totalCostSim = MoneyAmount.builder()
                                        .amount(sale.getCommercialOperation().get(0).getDeviceOffering().get(1)
                        ...
                        com.tdp.ms.sales.model.dto.quotation.Item itemSim = com.tdp.ms.sales.model.dto.quotation.Item
                                        .builder()
                                        .offeringId("SIM_FE".concat(sale.getCommercialOperation().get(0).getProduct()
                                                        .getPublicId()))
                                        .type("simcard")
                                        .publicId(sale.getCommercialOperation().get(0).getProduct().getPublicId())
                                        .orderActionId(org.apache.commons.lang3.StringUtils
                                                        .chop(sale.getCommercialOperation().get(0).getOrder()
                                                                        .getProductOrderReferenceNumber()))
                                        .totalCost(totalCostSim).build();
                        itemsList.add(itemSim);
                }

                String operationType = getOperationTypeForQuotationRequest(
                                sale.getCommercialOperation().get(0).getAdditionalData(),
                ...
                CreateQuotationRequestBody body = CreateQuotationRequestBody.builder().items(itemsList)
                                ...
                                .orderId("TEF" + String.format("%012d",
                                                new BigInteger(sale.getCommercialOperation().get(0).getOrder()
                                                                .getProductOrderId())))
                                ...
                                .financialEntity(sale.getCommercialOperation().get(0).getDeviceOffering().get(0)
                                                .getOffers().get(0).getBillingOfferings().get(0).getCommitmentPeriods()
                                                .get(0).getFinancingInstalments().get(0).getCodigo())
                                .build();

                if (operationType.equalsIgnoreCase("CAPL")) {
                        createQuotationRequest.setBody(null);
                } else {
                        createQuotationRequest.setBody(body);
                }
        ...
        public List<KeyValueType> additionalDataAssigments(List<KeyValueType> input, Sale saleRequest) {
                ...
                if (saleRequest.getCommercialOperation() != null && !saleRequest.getCommercialOperation().isEmpty()
                                && saleRequest.getCommercialOperation().get(0).getWorkOrDeliveryType()
                                                .getPlace() != null
                                && !saleRequest.getCommercialOperation().get(0).getWorkOrDeliveryType().getPlace()
                                                .isEmpty()
        ...
        private PortabilityDetailsType buildMobilePortabilityType(Sale saleRequest) throws ParseException {
                ...
                String customerEmail = saleRequest.getProspectContact().stream()
                                .filter(item -> item.getMediumType().equalsIgnoreCase("email address")).findFirst()
                ...
                portabilityDetailsType.setCustomerContactPhone(
                                StringUtils.isEmpty(portabilityType.getCustomerContactPhone()) ? null
                                                : portabilityType.getCustomerContactPhone());
        ...
        private CreateProductOrderGeneralRequest altaCommercialOperation(Sale saleRequest,
                ...
                NewAssignedBillingOffers altaNewBo1 = NewAssignedBillingOffers.builder()
                                .productSpecPricingId(saleRequest.getCommercialOperation().get(0).getProductOfferings()
                                                .get(0).getProductOfferingPrice().get(0)
                ...
                if (altaCombo) {
                        ...
                        // altaChangedContainedProductList.get(0).setProductId(""); // Doesnt sent it in
                        // Alta
                }
                ...
                if (Boolean.TRUE.equals(isRetail)
                                && saleRequest.getStatus().equalsIgnoreCase(Constants.STATUS_VALIDADO)) {
                        String iccidSim = this.getStringValueByKeyFromAdditionalDataList(
                                        saleRequest.getAdditionalData(), "SIM_ICCID");
                ...
                if (isMobilePortability) {
                        ...
                        ChangedCharacteristic changedCharacteristicPortability1 = ChangedCharacteristic.builder()
                                        .characteristicId("7601").characteristicValue(saleRequest
                                                        .getCommercialOperation().get(0).getPortability().getPublicId())
                                        .build();
                ...
                newProductAlta1.setProductCatalogId(saleRequest.getCommercialOperation().get(0).getProductOfferings()
                                .get(0).getProductOfferingProductSpecId());
                ...
                List<FlexAttrType> altaOrderAttributesList = this.commonOrderAttributes(saleRequest, flgFinanciamiento,
                                sendInd);
                ...
                if (Boolean.TRUE.equals(isRetail)
                        ...
                        String paymentNumber = this.getStringValueByKeyFromAdditionalDataList(
                                        saleRequest.getAdditionalData(), "NUMERO_TICKET");
                        ...
                        DeviceOffering deviceOfferingSmartphone = saleRequest.getCommercialOperation().get(0)
                                        ...
                                        .findFirst().orElse(null);
                        if (deviceOfferingSmartphone != null) {
                                String deviceSku = this.getStringValueByKeyFromAdditionalDataList(
                                                saleRequest.getAdditionalData(), Constants.DEVICE_SKU);
                        ...
                        DeviceOffering deviceOfferingSim = saleRequest.getCommercialOperation().get(0)
                                        ...
                                        .findFirst().orElse(null);
                        if (deviceOfferingSim != null) {
                                String simSku = this.getStringValueByKeyFromAdditionalDataList(
                                                saleRequest.getAdditionalData(), Constants.SIM_SKU);
                        ...
                        String cashierRegisterNumber = this.getStringValueByKeyFromAdditionalDataList(
                                        saleRequest.getAdditionalData(), Constants.NUMERO_CAJA);
                ...
                AltaMobileRequest altaRequest = AltaMobileRequest.builder().newProducts(altaNewProductsList)
                                ...
                                .shipmentDetails(saleRequest.getCommercialOperation().get(0)
                                                .getWorkOrDeliveryType() != null ? createShipmentDetail(saleRequest)
                                                                : null)
                                .cip(cipCode)
                                .upfrontIndicator(sendInd ? setUpFrontIndicator(saleRequest.getProductType()) : null)
                                .build();
        ...
        public void validationToAddSimcardBonus(Sale sale,
                ...
                if (sale.getCommercialOperation().get(0).getDeviceOffering() != null) {
                        // Simcard bonus conditional
                        DeviceOffering deviceOfferingSimcard = sale.getCommercialOperation().get(0).getDeviceOffering()
                                        .stream()
                                        .filter(item -> item.getDeviceType()
                                                        .equalsIgnoreCase(Constants.DEVICE_TYPE_SIM))
                                        .findFirst().orElse(null);
                        ...
                        if (deviceOfferingSimcard != null && deliveryMethod.equalsIgnoreCase("SP")) { // FEMS-5081 new
                                                                                                      // conditional
                                                                                                      // only simcard
                                                                                                      // and delivery
                                // NewAssignedBillingOffer SIM
                                String productSpecPricingId = bonificacionSimcardResponse.getData().get(0).getValue(); // Old
                                                                                                                       // "34572615",
                                                                                                                       // New
                                                                                                                       // "4442848"
                                                                                                                       // FEMS-5081
        ...
        public CreateProductOrderGeneralRequest caplCommercialOperation(Sale saleRequest,
                ...
                if (saleRequest.getCommercialOperation().get(0).getProduct().getProductOffering() != null
                                || !saleRequest.getCommercialOperation().get(0).getProduct().getProductOffering()
                                                .getId().equals(saleRequest.getCommercialOperation().get(0)
                                                                .getProductOfferings().get(0).getId())) {
                        flgOnlyCapl = false;
                }
                ...
                if (flgOnlyCapl) {
                        ...
                        caplBoRemoved1.setBillingOfferId(this.getStringValueByKeyFromAdditionalDataList(
                                        saleRequest.getCommercialOperation().get(0).getProduct().getAdditionalData(),
                                        "billingOfferId"));
                ...
                List<FlexAttrType> caplOrderAttributes = this.commonOrderAttributes(saleRequest, flgFinanciamiento,
                                sendInd);
                ...
                CaplRequest caplRequest = CaplRequest.builder().newProducts(caplNewProductsList).sourceApp("FE")
                                ...
                                .shipmentDetails(!StringUtils.isEmpty(deliveryMethod) && !deliveryMethod.equals("IS")
                                                && saleRequest.getCommercialOperation().get(0)
                                                                .getWorkOrDeliveryType() != null
                                                                                ? createShipmentDetail(saleRequest)
                                                                                : null)
                                .build();
        ...
        public ShipmentDetailsType createShipmentDetail(Sale saleRequest) {
                ...
                shipmentDetailsType.setRecipientTelephoneNumber(saleRequest.getCommercialOperation().get(0)
                                .getWorkOrDeliveryType().getContact().getPhoneNumber());
                shipmentDetailsType.setShippingLocality(saleRequest.getCommercialOperation().get(0)
                                .getWorkOrDeliveryType().getPlace().get(0).getAddress().getStateOrProvince());
                shipmentDetailsType.setShipmentAddressId(saleRequest.getCommercialOperation().get(0)
                                .getWorkOrDeliveryType().getPlace().get(0).getId());
                shipmentDetailsType.setShipmentSiteId("NA");
                saleRequest.getProspectContact().stream().filter(
                                item -> item.getMediumType().equalsIgnoreCase(Constants.MEDIUM_TYPE_EMAIL_ADDRESS))
                                .findFirst().ifPresent(contactMedium -> {
                                        shipmentDetailsType.setRecipientEmail(
                                                        contactMedium.getCharacteristic().getEmailAddress());
                                });
                // additional Datas
                ...
                CollectionUtils.emptyIfNull(saleRequest.getCommercialOperation().get(0).getWorkOrDeliveryType()
                                .getPlace().get(0).getAdditionalData()).stream().forEach(item -> {
        ...
        public CreateProductOrderGeneralRequest caeqCommercialOperation(Sale saleRequest,
                ...
                if (flgCasi) {
                        newProductCaeq1.setProductCatalogId(saleRequest.getCommercialOperation().get(0)
                                        .getProductOfferings().get(0).getProductOfferingProductSpecId());
                }
                ...
                // Refactored Code from CAPL
                List<FlexAttrType> caeqCaplOrderAttributes = this.commonOrderAttributes(saleRequest, flgFinanciamiento,
                                sendInd);
        ...
        public CreateProductOrderGeneralRequest caeqCaplCommercialOperation(Sale saleRequest,
                ...
                if (flgOnlyCapl) {
                        ...
                        caeqCaplBoRemoved1.setBillingOfferId(this.getStringValueByKeyFromAdditionalDataList(
                                        saleRequest.getCommercialOperation().get(0).getProduct().getAdditionalData(),
                                        "billingOfferId"));
        ...
        public List<FlexAttrType> commonOrderAttributes(Sale saleRequest, final Boolean flgFinanciamiento,
                ...
                if (sendIndicator && flgFinanciamiento) {
                        // FEMS-5497
                        FinancingInstalment financingInstalment = saleRequest.getCommercialOperation().get(0)
                                        .getDeviceOffering().get(0).getOffers().get(0).getBillingOfferings().get(0)
                                        .getCommitmentPeriods().get(0).getFinancingInstalments().get(0);
        ...
        private void casiAndRetailOrderAttributes(List<FlexAttrType> caeqOrderAttributes, Sale saleRequest,
                ...
                if (flgCasi && isRetail) {
                        String deviceSkuValue = this.getStringValueByKeyFromAdditionalDataList(
                                        saleRequest.getAdditionalData(), "DEVICE_SKU");
                        String simSkuValue = this.getStringValueByKeyFromAdditionalDataList(
                                        saleRequest.getAdditionalData(), "SIM_SKU");
                        String cashierRegisterNumber = this.getStringValueByKeyFromAdditionalDataList(
                                        saleRequest.getAdditionalData(), Constants.NUMERO_CAJA);

                        FlexAttrValueType deviceSkuAttrValue = FlexAttrValueType.builder().stringValue(deviceSkuValue)
                                        .valueType(Constants.STRING).build();
                        FlexAttrType deviceSkuTypeAttr = FlexAttrType.builder().attrName("DEVICE_SKU")
                                        .flexAttrValue(deviceSkuAttrValue).build();
                        ...
                        FlexAttrValueType simSkuAttrValue = FlexAttrValueType.builder().stringValue(simSkuValue)
                                        .valueType(Constants.STRING).build();
                        FlexAttrType simSkuTypeAttr = FlexAttrType.builder().attrName("SIM_SKU")
                                        .flexAttrValue(simSkuAttrValue).build();
        ...
        private Boolean getRetailFlag(Sale saleRequest) {
                String flowSaleValue = saleRequest.getAdditionalData().stream()
                                .filter(keyValueType -> keyValueType.getKey().equalsIgnoreCase(Constants.FLOWSALE))
                                .findFirst().orElse(KeyValueType.builder().value("NotRetail").build()).getValue();
        ...
        public List<ChangedContainedProduct> changedContainedCaeqList(Sale saleRequest, String tempNum,
                ...
                ChangedCharacteristic changedCharacteristic2 = ChangedCharacteristic.builder().characteristicId("15734")
                                .characteristicValue(saleRequest.getCommercialOperation().get(0).getDeviceOffering()
                                                .stream().filter(item -> !item.getDeviceType().equalsIgnoreCase("SIM"))
                                                .findFirst().orElse(DeviceOffering.builder().id(null).build()).getId())
                                .build();
                ...
                if (isRetail && saleRequest.getStatus().equalsIgnoreCase(Constants.VALIDADO)) {
                        String deviceImei = this.getStringValueByKeyFromAdditionalDataList(
                                        saleRequest.getAdditionalData(), "MOVILE_IMEI");
                ...
                if (saleRequest.getCommercialOperation().get(0).getDeviceOffering().size() == 1) {
                        ChangedCharacteristic changedCharacteristic4 = ChangedCharacteristic.builder()
                                        ...
                                        .characteristicValue(
                                                        saleRequest.getCommercialOperation().get(0).getDeviceOffering()
                                                                        .get(0).getSimSpecifications().get(0).getType())
                                        .build();
                ...
                if (!saleRequest.getCommercialOperation().get(0).getReason().equalsIgnoreCase(Constants.PORTABILIDAD)
                                ...
                                && saleRequest.getCommercialOperation().get(0).getProduct()
                                                .getProductRelationShip() != null) {
                        // FEMS-3799 (CR)
                        setChangedContainedProductProductId(changedContainedProduct1, saleRequest
                                        .getCommercialOperation().get(0).getProduct().getProductRelationShip());
                }

                List<ChangedContainedProduct> changedContainedProductList = new ArrayList<>();
                // FEMS3873 - CASI attributes
                return casiAttributes(saleRequest, sapidSimcardBp, changedContainedProduct1,
                                changedContainedProductList, flgCasi);
        }
        ...
        private List<ChangedContainedProduct> casiAttributes(Sale saleRequest, String sapidSimcardBp,
                        ...
                        List<ChangedContainedProduct> changedContainedProductList, Boolean flgCasi) {
                // Cuando viene activo el flag de CASI
                if (flgCasi) {
                        List<RelatedProductType> productRelationShipList = saleRequest.getCommercialOperation().get(0)
                                        .getProduct().getProductRelationShip();
                        // Buscar el productId para simcard
                        String simcardProductId = productRelationShipList.stream().filter(prs -> prs.getProduct()
                                        .getDescription().equalsIgnoreCase(Constants.SIM_DEVICE)
                        ...
                        String deviceProductId = productRelationShipList.stream().filter(prs -> !prs.getProduct()
                                        .getDescription().equalsIgnoreCase(Constants.SIM_DEVICE)
                                        && !prs.getProduct().getDescription().equalsIgnoreCase("Simcard")).findFirst()
                                        .orElse(RelatedProductType.builder()
                                                        .product(ProductRefInfoType.builder().id(null).build()).build())
        ...
        private void setChangedContainedProductProductId(ChangedContainedProduct changedContainedProduct,
                ...
                // FEMS-3799 (CR)
                productRelationShip.stream().filter(
                                item -> item.getProduct().getDescription().equalsIgnoreCase(Constants.SIM_DEVICE))
                                .findFirst()
                                .ifPresent(item -> item.getProduct().getProductRelationship().stream()
                                                .filter(pr -> pr.getProduct().getDescription()
                                                                .equalsIgnoreCase(Constants.PRODUCT_TYPE_DEVICE))
                                                .findFirst().ifPresent(pr -> changedContainedProduct
                                                                .setProductId(pr.getProduct().getId())));
        }
        ...
        private String getAcquisitionTypeValue(Sale saleRequest) {
                ...
                // Getting Commercial Operation Types from Additional Data
                final Boolean[] flgAlta = { false };
                saleRequest.getCommercialOperation().get(0).getAdditionalData().stream().forEach(additionalData -> {
                ...
                if (flgAlta[0] && saleRequest.getCommercialOperation().get(0).getDeviceOffering().size() == 1) { // Identifying
                                                                                                                 // if
                                                                                                                 // is
                                                                                                                 // Alta
                                                                                                                 // only
        ...
        private ReserveStockRequest buildReserveStockRequest(ReserveStockRequest request, Sale sale,
                        CreateProductOrderResponseType createOrderResponse, String sapidSimcardBp) {
                request.setReason("PRAEL");

                List<String> requiredActionList = new ArrayList<>();
                requiredActionList.add(sale.getCommercialOperation().get(0).getReason().equalsIgnoreCase("ALTA") || sale
                                .getCommercialOperation().get(0).getReason().equalsIgnoreCase(Constants.PORTABILIDAD)
                                                ? "PR"
                                                : "CH");
                ...
                // Equipment Item
                DeviceOffering deviceOfferingSmartphone = sale.getCommercialOperation().get(0).getDeviceOffering()
                                .stream()
        ...
        private Mono<Sale> wirelineMigrations(List<BusinessParameterFinanciamientoFijaExt> parametersFinanciamientoFija,
                        PostSalesRequest request, String actionType, Boolean isRetail, String cipCode) {
                ...
                List<RelatedProductType> productRelationShip = commercialOperationTypeList.get(0).getProduct()
                                .getProductRelationShip();
                List<ComposingProductType> productSpecification = commercialOperationTypeList.get(0)
                                .getProductOfferings().get(0).getProductSpecification();
                ...
                productRelationShip.forEach(item -> {
                        if (compareComponents(item.getProduct().getProductType())) {
                                ...
                                migrationComponentList.add(MigrationComponent.builder()
                                                ...
                                                .productId(StringUtils.isEmpty(productId) ? null : productId).build());
                        }
                });
                ...
                List<NewProductMigracionFija> newProducts = broadbandPlanBAF(migrationComponentList,
                                productRelationShip, commercialOperationTypeList.get(0).getProductOfferings());
                ...
                migracionFijaRequest.setAppointmentId(
                                request.getSale().getCommercialOperation().get(0).getWorkOrDeliveryType() != null
                                                ? request.getSale().getCommercialOperation().get(0)
                                                                .getWorkOrDeliveryType().getWorkOrder()
                                                                .getWorkforceTeams().get(0).getId()
                                                : null);
                ...
                migracionFijaRequest.setCip(cipCode);

                boolean sendInd = isNecessaryToSendVariablesInOrderCreation(
                                request.getSale().getCommercialOperation().get(0));
                migracionFijaRequest.setUpfrontIndicator(
                                sendInd ? setUpFrontIndicator(request.getSale().getProductType()) : null);

                ProductOrderMigracionFijaRequest productOrderMigracionFijaRequest = ProductOrderMigracionFijaRequest
                                .builder().actionType(actionType).onlyValidationIndicator(Constants.STRING_FALSE)
                                .request(migracionFijaRequest).salesChannel(request.getSale().getChannel().getId())
                                .customer(com.tdp.ms.sales.model.dto.productorder.Customer.builder()
                                                ...
                                                .build())
                                .productOfferingId(request.getSale().getCommercialOperation().get(0)
                                                .getProductOfferings().get(0).getId())
                                .build();
                ...
                return createOrderFija(mainRequestProductOrder, request, request.getSale(), createQuotationFijaRequest,
                                isRetail);
        }
        ...
        private ServiceabilityInfoType buildServiceabilityInfoType(PostSalesRequest request) {
                ...
                CommercialZoneType commercialZone = CommercialZoneType.builder()
                                .commercialZoneId(request.getSale().getCommercialOperation().get(0)
                                                .getServiceAvailability().getCommercialAreaId())
                                .commercialZoneName(request.getSale().getCommercialOperation().get(0)
                                                .getServiceAvailability().getCommercialAreaDescription())
                                .build();
        ...
        private List<NewProductMigracionFija> broadbandPlanBAF(List<MigrationComponent> migrationComponentList,
                        List<RelatedProductType> productRelationShip, List<OfferingType> productOfferings) {
                final String[] productId = { null };
                productRelationShip.stream()
                                .filter(item -> item.getProduct().getProductType()
                                                .equalsIgnoreCase(Constants.PRODUCT_TYPE_BROADBAND)
                                                && item.getProduct().getName().equalsIgnoreCase("Internet_Plan"))
                                .findFirst().ifPresent(item -> productId[0] = item.getProduct().getId());

                final String[] characteristicValue = { null };
                productOfferings.get(0).getProductSpecification().stream().filter(
                                item -> item.getProductType().equalsIgnoreCase(Constants.PRODUCT_TYPE_BROADBAND))
                                .findFirst().ifPresent(item -> {
                                        characteristicValue[0] = item.getProductPrice().get(2).getAdditionalData()
                                                        .stream()
                                                        .filter(keyValueType -> keyValueType
                                                                        .getKey().equalsIgnoreCase("downloadSpeed"))
                                                        .findFirst()
                                                        .orElseThrow(() -> buildGenesisError(
                                                                        Constants.BAD_REQUEST_EXCEPTION_ID,
                ...
                migrationComponentList.stream()
                                .filter(migrationComponent -> migrationComponent.getComponentName()
                                                .equalsIgnoreCase(Constants.PRODUCT_TYPE_BROADBAND))
                                .findFirst().ifPresent(migrationComponent -> {
                                        try {
                                                migrationComponent.setProductChanges(ProductChangeAltaFija.builder()
                                                                .changedContainedProducts(Collections.singletonList(
                                                                                ChangedContainedProduct.builder()
                                                                                                .productId(productId[0])
                                                                                                .temporaryId("temp")
                                                                                                .changedCharacteristics(
                                                                                                                Arrays.asList(ChangedCharacteristic
                                                                                                                                .builder()
                                                                                                                                .characteristicId(
                                                                                                                                                "3241482")
                                                                                                                                .characteristicValue(
                ...
                productOfferings.forEach(productOffering -> {
                        if (productOffering.getProductSpecification().get(0).getProductType()
                                        .equalsIgnoreCase(Constants.PRODUCT_TYPE_SVA)) {
                                String productType = getStringValueByKeyFromAdditionalDataList(
                                                productOffering.getAdditionalData(), Constants.PRODUCT_TYPE);
                                if (productType.equalsIgnoreCase(Constants.PRODUCT_TYPE_CABLE_TV)
                                        ...
                                        NewAssignedBillingOffers newAssignedBillingOffers = NewAssignedBillingOffers
                                                        .builder().productSpecPricingId(productOffering.getId())
                                                        .parentProductCatalogId(
                                                                        this.getStringValueByKeyFromAdditionalDataList(
                                                                                        productOffering.getAdditionalData(),
                                                                                        "parentProductCatalogID"))
                                                        .build();
                                        ...
                                        migrationComponentList.stream()
                                                        .filter(item -> item.getComponentName()
                                                                        .equalsIgnoreCase(finalProductType))
                                                        .findFirst().ifPresent(item -> {
                                                                if (item.getProductChanges()
                                                                                .getNewAssignedBillingOffers() == null) {
                                                                        item.getProductChanges()
                                                                                        .setNewAssignedBillingOffers(
                                                                                                        new ArrayList<>());
                                                                }
                                                                item.getProductChanges().getNewAssignedBillingOffers()
                                                                                .add(newAssignedBillingOffers);
                                                        });
                                }
                        }
                });

                // Paso 3: relacionar el plan de oferta con ID de parque según sea cada
                // componente
        ...
        private GenesisException buildGenesisError(String exceptionId, String description) {
                return GenesisException.builder().exceptionId(exceptionId).wildcards(new String[] { description })
                                .build();
        }
        ...
        private List<NewProductMigracionFija> matchingMigrationOffers(List<MigrationComponent> migrationComponentList) {
                ...
                migrationComponentList.forEach(migrationComponent -> {
                        newProducts.add(NewProductMigracionFija.builder()
                                        ...
                                        .productChanges(migrationComponent.getProductChanges()).build());
                });
                return newProducts;
        }
        ...
        private void fillProductOfferingProductSpecId(List<MigrationComponent> migrationComponentList,
                ...
                productSpecificationList.forEach(productSpecification -> {
                        ...
                        if (Boolean.TRUE.equals(compareComponents(productTypeName))) {
                                ...
                                ProductSpecCharacteristicType productCharacteristic = productSpecification
                                                .getRefinedProduct().getProductCharacteristics().stream()
                                                .filter(item -> item.getName()
                                                                .equalsIgnoreCase("productOfferingProductSpecID"))
                                                .findFirst().orElse(null);

                                MigrationComponent migrationComponent = migrationComponentList.stream()
                                                .filter(migrationComponentItem -> migrationComponentItem
                                                                .getComponentName().equalsIgnoreCase(productTypeName))
                                                .findFirst().orElse(null);

                                if (migrationComponent != null) {
                                        // TODO: validar qué campo es
                                        // productCharacteristics.productSpecCharacteristicValue.value. Por ahora se usa
                                        // roductCharacteristics.id
                                        migrationComponent
                                                        .setProductOfferingProductSpecId(productCharacteristic.getId());
                                } else {
                                        migrationComponentList.add(MigrationComponent.builder()
                                                        .componentName(productTypeName).productId(null)
