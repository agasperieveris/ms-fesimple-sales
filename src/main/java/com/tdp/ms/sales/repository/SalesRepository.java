...
public interface SalesRepository extends ReactiveCosmosRepository<Sale, String> {
    ...
    Flux<Sale> findByChannel_IdContainingAndChannel_DealerIdContainingAndAgent_IdContainingAndAgent_NationalIdContainingAndAgent_NationalIdTypeContainingAndChannel_StoreIdContainingAndStatusContaining(String channelId, String dealerId, String idAgent, String nationalID, String nationalIdType, String storeId, String status);
}
